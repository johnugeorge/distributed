...
public class LocatedBlocks implements Writable {
  ...
  public LocatedBlocks(long flength, List<LocatedBlock> blks, boolean isUnderConstuction) {
    ...
    System.out.println("Located Blocks flength "+flength+" isUnderConstuction "+isUnderConstuction);
  }
  ...
  public boolean isUnderConstruction() {
	  System.out.println("isUnderConstuction Returned "+ underConstruction);
